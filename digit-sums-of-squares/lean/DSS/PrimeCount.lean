...
**Corollary 1.11** in bases `2` and `3`: many squares below `X` with prime
...
admissibility modulo `2` holds for every odd prime.  Theorem 1.10 then counts
the representations.
...
/-- **Corollary 1.11, base 2**: for `N ≥ 36864` there are at least
...
/-- **Corollary 1.11, base 3**: for `N ≥ 186624` there are at least
