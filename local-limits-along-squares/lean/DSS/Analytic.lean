...
The one real-analysis inequality behind Theorem 3.1: at the peak
...
This is the whole of the asymptotic content of the main-term/error
comparison in Theorem 3.1, at `ε = 1/4`: with
