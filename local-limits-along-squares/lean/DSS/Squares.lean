...
**Theorem 1.8 of the paper**: for every base `b ≥ 2` and every sufficiently
...
/-- The solutions counted by Theorem 1.8: `n` coprime to the base, with
...
/-- **Theorem 1.8, `b ≥ 3`.**  If `q ≥ 2304·b⁴` is admissible — congruent to
...
/-- **Theorem 1.8, `b = 2`.**  Every `q ≥ 36864` — no admissibility condition
